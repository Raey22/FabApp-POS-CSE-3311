                  ...
                  <tbody>
                    ...
                    ")) {
                      while ($row = $result->fetch_assoc()) { ?>
                        <!-- Edit Material -->
                        <td align="center">
                          <a href="edit_product.php?id=<?php echo ("".$row['inv_id']); ?>"  class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>

                          <!-- <form method="GET" action="product.php">
                            <input type="hidden" name="id" value="<?php echo($row['inv_id']); ?>">
                            <button type="submit" class="btn btn-warning">PRESS ME!</button>
                          </form> -->

                          <!-- <a href="product.php?id=<?php echo ("".$row['inv_id']); ?>" class="btn btn-success btn-sm"><i class="fas fa-cart-plus"></i></a></span> -->
                        </td>
