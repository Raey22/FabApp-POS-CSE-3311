...
-- note: Update this File to include AUTO_INCREMENT for table sheet_good_inventory
-- also note: bug found in INSERT `materials` table : incomplete m_id incrementing
